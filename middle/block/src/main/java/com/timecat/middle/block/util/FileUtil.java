...
/**
 * Created by ywwynm on 2016/3/20. utils for operating {@link File}s
 */
public class FileUtil {
     ...
     * @see ://stackoverflow.com/a/15612964/3952691
     */
    ...
    public static String readStringFromFile(File file) {
        ...
        try {
            ...
            if (reader != null) {
                try { // I found this style is really sexy, can you find another similar one(maybe or two) in my code?
                    reader.close();
                } catch (IOException e) {
                    e.printStackTrace();
                }
