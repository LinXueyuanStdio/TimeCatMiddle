...
/**
 * Created by ywwynm on 2017/1/17. Store settings that will be seen frequently during app lifecycle,
 * which will also influence ui very constantly. Usually, these settings belong to settings for UI
 * that can be seen under ui category in
 */
public class FrequentSettings {
    ...
    private static SharedPreferences getSp() {
        return BaseApplication.getContext().getSharedPreferences(
                Def.Meta.PREFERENCES_NAME, Context.MODE_PRIVATE);
    }
