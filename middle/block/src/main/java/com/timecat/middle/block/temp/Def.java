...
/**
 * Created by ywwynm on 2015/5/21. Def for EverythingDone
 */
public final class Def {
    ...
    public static final class Meta {
        ...
        public static final String APP_AUTHORITY = "com.timecat.module.editor.idea";
        public static final String APP_FILE_DIR =
                Environment.getExternalStorageDirectory().getAbsolutePath() + "/timecat/mini";
        public static final String FEEDBACK_EMAIL = "761516186@qq.com";
    ...
    public static final class Database {
        ...
        public static final String COLUMN_STATE_THINGS = "status";
        ...
        public static final String COLUMN_FINISH_TIME_THINGS = "finishTime";
    ...
    public static final class Communication {
        ...
        private static final String PREFIX = "com.timecat.module.editor.idea.";
        ...
        public static final String KEY_TYPE_IMAGE_PATH_NAME = PREFIX + "key.type_iamge_path_name";
        public static final String KEY_TYPE_VIDEO_PATH_NAME = PREFIX + "key.type_video_path_name";
        ...
        public static final String AUTHENTICATE_ACTION_VIEW =
                PREFIX + "action.authenticate.rootView";
