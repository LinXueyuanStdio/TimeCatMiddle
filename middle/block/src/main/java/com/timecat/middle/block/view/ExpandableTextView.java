...
//            L.i("================================lineCount:" + lineCount + "======================================");
            if (lineCount > MAX_COLLAPSED_LINES) {
                ...
                tv_expand_or_collapse.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_arrow_down_white_24dp, 0, 0);
            ...
            switch (state) {
                ...
                case STATE_COLLAPSED:
                    tv_expandable_content.setMaxLines(MAX_COLLAPSED_LINES);
                    tv_expand_or_collapse.setVisibility(View.VISIBLE);
                    tv_expand_or_collapse.setCompoundDrawablesRelativeWithIntrinsicBounds(0, R.drawable.ic_arrow_down_white_24dp, 0, 0);
                    break;
                case STATE_EXPANDED:
                    tv_expandable_content.setMaxLines(Integer.MAX_VALUE);
                    tv_expand_or_collapse.setVisibility(View.VISIBLE);
                    tv_expand_or_collapse.setCompoundDrawablesRelativeWithIntrinsicBounds(0, R.drawable.ic_arrow_up_white_24dp, 0, 0);
                    break;
            }
            tv_expandable_content.setText(text);
        }
    ...
    public void onClick(View v) {
        ...
        if (state == STATE_COLLAPSED) {
            tv_expand_or_collapse.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_arrow_up_white_24dp, 0, 0);
            tv_expandable_content.setMaxLines(Integer.MAX_VALUE);
